    ...
    <>
      ...
      {ventana === 'polarizado' && (
        <Ventana titulo="Polarizado antivandálico marca Strong" cerrar={() => setVentana(null)}>
          <p>El logo de Strong está en la tapa del baúl, junto a la óptica izquierda.</p>
          <Image className="ventana-foto" src="/car/mejoras/polarizado-strong.jpg" alt="Logo de Strong en la tapa del baúl" width={960} height={800} sizes="(max-width: 860px) 90vw, 560px" />
        </Ventana>
      )}
    </>
  );
